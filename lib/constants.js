...
// Product categories with subcategories and sub-subcategories
...
export function getAllSubSubcategories() {
...
export function getCategoryHierarchy(category, subCategory, subSubCategory) {
  const parts = []
